#!/usr/bin/env python3
"""Jerry — Terminal Screen Capture & Control

Captures live terminal text and sends input using tmux.
Cross-platform: works on Termux, Linux, macOS with tmux installed.
"""
...
class TerminalController:
    ...
    def __init__(self):
        self.tmux_session = "jerry-control"  # Default tmux session
    ...
    def _capture_scrollback(self, lines: int) -> str:
        ...
        return (
            ...
            "Install: pkg install tmux (Termux) | brew install tmux (macOS) | apt install tmux (Linux)\n"
            "Then run Jerry inside a tmux session: tmux new -s jerry\n"
        )
